...
if __name__ == '__main__':
    # 创建结果保存文件夹
    os.makedirs('myresnet50', exist_ok=True)
    ...
    #results_df.to_excel('myresnet50/training_results.xlsx', index=False)
    results_df.to_csv('myresnet50/training_results.csv', index=False)
    ...
    plt.tight_layout()
    plt.savefig('myresnet50/loss_accuracy_plot.png')
    plt.show()
