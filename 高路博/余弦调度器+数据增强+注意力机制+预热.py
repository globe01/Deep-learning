...
if __name__ == '__main__':
    # 创建结果保存文件夹
    os.makedirs('new_try_result', exist_ok=True)
    ...
    results_df.to_csv('new_try_result/training_results.csv', index=False)
    ...
    plt.tight_layout()
    plt.savefig('new_try_result/loss_accuracy_plot.png')
    plt.show()
