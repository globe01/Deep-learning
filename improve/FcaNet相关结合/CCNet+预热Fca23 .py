...
class Bottleneck(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1, Fca=False,reduction=16):
...
class ResNet(nn.Module):
    ...
    def _make_layer(self, block, planes, num_blocks, stride, Fca=False):
        strides = [stride] + [1] * (num_blocks - 1)
        layers = []
        for stride in strides:
            layers.append(block(self.in_planes, planes, stride, Fca))
