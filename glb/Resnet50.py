...
if __name__ == '__main__':
    # 创建结果保存文件夹
    os.makedirs('resnet50_result', exist_ok=True)
    ...
    results_df.to_excel('resnet50_result/training_results.xlsx', index=False)
    ...
    plt.tight_layout()
    plt.savefig('resnet50_result/loss_accuracy_plot.png')
    plt.show()
